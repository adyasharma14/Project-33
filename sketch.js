...
function draw()
 {
  ...
  if(gameState != "end")
  {
    ...
    text("No. of times you played : " + count,50,60);
    text("Total no. of times you can play : 5 ",50,40);
  ...
  else
  {
    ...
    textSize(30);
    fill("yellow");
    text("Your Score: " + score, 255,350);
    text("Thank you for playing PLINKO!!:)",150,120);
    text("Hope you liked my game ^_^",180,145);
  }
